...
Blockierte Geräte werden im Geräte-Manager als blockiert angezeigt und Benutzer sehen eine Benachrichtigung, dass das Gerät nicht verwendet werden kann.

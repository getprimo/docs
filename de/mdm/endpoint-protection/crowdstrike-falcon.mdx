...
**2.1 Das macOS-Paket importieren**
...
1. Suchen Sie in der Konfiguration für das macOS .pkg-Paket das Feld „Skript installieren“ (erweiterte Optionen anzeigen).
...
Erstellen Sie zwei separate Richtlinien, um zu bestätigen, dass der CrowdStrike-Agent sowohl auf macOS- als auch auf Windows-Geräten installiert ist.

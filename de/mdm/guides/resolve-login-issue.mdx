...
Auf macOS können mehrere fehlgeschlagene Versuche **Recovery OS** auslösen, was die Passwortwiederherstellung komplexer macht.
...
Auf macOS fordern einige Anmeldeaufforderungen – insbesondere beim Entsperren von FileVault, bei der Verwendung von Funktionen auf Administratorebene oder nach einer Richtlinienänderung – tatsächlich ein **SecureToken**-fähiges Konto und nicht das reguläre Anmeldekennwort.

...
description: "Die Seite stellt nützliche Skripte zum Ändern von Hostnamen auf macOS und zum Entfernen der USB-Blockierung auf Windows bereit und betont, wie wichtig es ist, ihre Ausgaben vor der Implementierung zu überprüfen, da für diese Skripte keine Unterstützung verfügbar ist."
hidden: true
---
...
Bei einigen Benutzern kann es zu wiederholten Installations-Popups für das Slack-Hilfstool auf macOS kommen, wenn Slack.app im Besitz von Root ist, selbst nach der Eingabe von Administratoranmeldeinformationen. Um dieses Problem zu beheben, führen Sie das folgende Skript auf dem betroffenen Computer als Administrator aus, um den Besitz von Slack.app auf den aktuell angemeldeten Benutzer zu ändern:

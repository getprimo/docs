...
description: "CIS-Benchmarks sind von der Community entwickelte sichere Konfigurationsleitfäden, die dabei helfen, Systeme und Netzwerke zu härten. Sie bieten zwei Profilebenen, um Sicherheit und Benutzerfreundlichkeit in Einklang zu bringen, und bieten gleichzeitig ein detailliertes Skript für die Implementierung von Richtlinien über FleetDM."
---
...
Fleet stellt **Richtlinienabfragen** bereit, um die CIS-Konformität unter macOS 13+ und Windows 10+ (Enterprise) zu bewerten.
...
4. Klicken Sie auf „Einstellung aktivieren“
5. Navigieren Sie zu den Registerkarten **Mac, Windows** und **iOS**, um sie jeweils zu konfigurieren.
...
5. Laden Sie für **macOS** die folgende mobileconfig hoch
...
Befolgen Sie die gleichen Schritte wie im Abschnitt zur macOS-Festplattenverschlüsselung oben – die Verschlüsselungskarte in Profilen gilt für beide Plattformen.

### Passwortrichtlinie und automatische Bildschirmsperre

*Diese Richtlinie wurde mit Primo erstellt und funktioniert für iOS-, macOS- und Windows-Geräte.*

Befolgen Sie die gleichen Schritte wie im Abschnitt zur macOS-Passwortrichtlinie oben. Stellen Sie sicher, dass Sie die Registerkarte **Windows** separat konfigurieren.

### Integrierte Firewall

*Diese Richtlinie wurde mit Primo erstellt und funktioniert sowohl für macOS- als auch für Windows-Geräte.*

Befolgen Sie die gleichen Schritte wie im Abschnitt über die integrierte macOS-Firewall oben – die Firewall-Karte in den Profilen gilt für beide Plattformen.

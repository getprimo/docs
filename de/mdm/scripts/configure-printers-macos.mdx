---
title: "Konfigurieren Sie Drucker für macOS"
description: "Erfahren Sie, wie Sie IPP-Drucker auf macOS-Geräten konfigurieren, indem Sie verfügbare Drucker im Netzwerk ermitteln, ihre IP-Adressen identifizieren, eine mobileconfig-Datei generieren und die Konfiguration für eine nahtlose Druckintegration importieren."
---
...
3. **Beachten** Sie die Liste der erkannten Drucker und deren IPP-URIs.
...
2. Notieren Sie die IP-Adressen und die entsprechenden IPP-URIs.
...
4. **Speichern** und **bereitstellen** Sie das Profil.

...
![Screenshot: Access Rules](/images/notion-import/set-up-licence-provisioning__img-090__block-0008__25443d9f.png)
...
4. Save your rule.
    ![Screenshot: Create new Rules (optional)](/images/notion-import/set-up-licence-provisioning__img-091__block-0016__25443d9f.png)


## Enable provisioning for an application

![Screenshot: Create new Rules (optional)](/images/notion-import/set-up-licence-provisioning__img-092__block-0017__25443d9f.png)
...
- Enable **Provisioning** and assign the role *Light agent*.
    ![Screenshot: Enable provisioning for an application](/images/notion-import/set-up-licence-provisioning__img-093__block-0030__25443d9f.png)

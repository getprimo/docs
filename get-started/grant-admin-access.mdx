...
| **MDM Manager** | Access to device management, MDM (Mobile Device Management) settings, policies, and enrollment. |
| **SaaS Manager** | Access to identity, SaaS app connections, provisioning rules, and licenses. |

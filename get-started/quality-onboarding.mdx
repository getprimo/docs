...
- Administrator access to your HRIS or HR data source (if using HRIS sync).
- Access to an Apple account to generate the APN certificate (required for MDM on Apple devices).
- Admin access to your SaaS tools if you plan to use Primo for access management.
...
Automatic reminders are sent every 7 days to employees who haven't completed installation. Track progress from your dashboard.

...
Primo si affida al Secure Token per gestire in modo sicuro gli utenti macOS.
...
Puoi verificare rapidamente se l'account amministratore macOS utilizzato da Primo contiene un token di sicurezza attivo.

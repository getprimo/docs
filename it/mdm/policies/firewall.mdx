...
- **Blocca tutte le connessioni in entrata**: consente solo le connessioni richieste dai servizi Internet di base (come DHCP e Bonjour). Utilizzare con cautela poiché ciò può interrompere la condivisione dei file e l'accesso remoto.

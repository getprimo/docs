...
description: "Scopri come distribuire in modo efficiente l'agente CrowdStrike Falcon su dispositivi macOS e Windows seguendo i passaggi per scaricare i file di installazione, importarli in FleetDM, configurare gli script di installazione e creare policy di conformità."
---
...
Questo articolo spiega come distribuire l'agente CrowdStrike Falcon su dispositivi macOS e Windows utilizzando FleetDM e Primo MDM. Imparerai come scaricare i pacchetti di installazione dalla console di amministrazione CrowdStrike, recuperare il tuo CustomerID, importare i pacchetti in FleetDM, configurare gli script di installazione e creare policy di conformità per entrambi i sistemi operativi.
...
**2.2 Importa il pacchetto Windows**
...
**Script di installazione macOS 3.1**
...
**3.2 Script di installazione di Windows**
...
### Passaggio 4: crea policy di conformità in FleetDM

Crea due policy separate per confermare che l'agente CrowdStrike è installato sia sui dispositivi macOS che su quelli Windows.

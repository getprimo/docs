...
description: "Scopri come verificare l'idoneità dei dispositivi Windows 10 per un aggiornamento a Windows 11 e automatizzare il processo di aggiornamento utilizzando i criteri FleetDM e gli script PowerShell, tra cui la classificazione dei dispositivi, la valutazione dell'idoneità e l'attivazione dell'installazione dell'aggiornamento."
---
...
Allega questo script di PowerShell alla policy sopra. Rileva la versione del TPM e lo stato di avvio protetto, quindi li scrive nel registro di Windows per FleetDM.
...
## 2. Valuta l'idoneità di un dispositivo Windows 10 per Windows 11
...
## 3. Attiva l'aggiornamento a Windows 11 (dispositivi idonei)

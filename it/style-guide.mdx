...
| Attributo | Significa | NON significa |
|---|---|---|
...
Utilizzare sempre i termini esatti del [glossario](/references/glossary.csv). Non sostituire mai i termini del glossario con sinonimi.

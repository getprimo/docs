...
Téléchargez ensuite les politiques sur votre instance FleetDM :
...
Suivez les mêmes étapes que la section Chiffrement de disque macOS ci-dessus : la carte de chiffrement dans les profils s'applique aux deux plates-formes.

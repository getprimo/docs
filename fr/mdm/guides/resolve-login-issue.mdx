...
## Vérifier l'état de SecureToken (macOS uniquement)

Sur macOS, certaines invites de connexion – en particulier lors du déverrouillage de FileVault, à l'aide de fonctionnalités de niveau administrateur ou après un changement de politique – demandent en fait un compte compatible **SecureToken**, et non le mot de passe de connexion habituel.

...
description: "Pour passer de Intune à FleetDM en tant que solution MDM, suivez les étapes pour déclarer le domaine FleetDM, créez l'application Fleet avec les autorisations nécessaires et définissez FleetDM comme MDM par défaut pour les nouveaux appareils dans le portail Azure."
---

<Tip>
[Trouvez ici toutes les informations](/fr/mdm/zero-touch/zero-touch-windows) lié au pilote automatique Windows et au déploiement Zero-Touch sur Windows avec Primo.
</Tip>
...
**Remarque** : Si vous avez commencé à inscrire des appareils avant d'effectuer ces étapes, veuillez nous en informer afin que nous puissions forcer le passage de MDM de Intune à FleetDM en exécutant un script (sinon, la machine sera dans un état incohérent pouvant affecter l'expérience).

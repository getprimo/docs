...
3. Edit the permissions associated with the API key
    ![Screenshot: Account for HRIS-specific requirements](/images/notion-import/connect-an-hris-to-primo__img-019__block-0028__23b43d9f.png)

4. Enable:
   - _View future employees_
   - _View departed employees_
       ![Screenshot: Account for HRIS-specific requirements](/images/notion-import/connect-an-hris-to-primo__img-020__block-0032__23b43d9f.png)
...
![Screenshot: Apply synchronization filters](/images/notion-import/connect-an-hris-to-primo__img-021__block-0055__23b43d9f.png)
...
![Screenshot: Define how fields are synchronized](/images/notion-import/connect-an-hris-to-primo__img-022__block-0065__23b43d9f.png)

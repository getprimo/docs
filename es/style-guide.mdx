...
- Sin riesgos: tenga confianza y sea directo
...
Utilice siempre términos exactos del [glosario](/references/glossary.csv). Nunca sustituya los términos del glosario por sinónimos.
...
5. **Próximos pasos**: enlace a contenido relacionado (si corresponde)

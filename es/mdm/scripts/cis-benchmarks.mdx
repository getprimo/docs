...
description: "CIS Benchmarks son guías de configuración segura desarrolladas por la comunidad que ayudan a reforzar los sistemas y las redes, proporcionando dos niveles de perfiles para equilibrar la seguridad y la usabilidad, al tiempo que ofrecen un script detallado para implementar políticas a través de FleetDM."
---
...
*Esta política tiene una plantilla con Primo y funciona para dispositivos iOS, macOS y Windows.*
...
Siga los mismos pasos que en la sección Cifrado de disco macOS anterior: la tarjeta de cifrado en los perfiles se aplica a ambas plataformas.
...
Siga los mismos pasos que en la sección anterior sobre Firewall integrado macOS: la tarjeta de Firewall en los perfiles se aplica a ambas plataformas.

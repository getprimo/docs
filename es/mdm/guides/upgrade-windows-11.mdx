---
title: "Actualización de Windows 10 a Windows 11"
description: "Aprenda cómo verificar la elegibilidad del dispositivo Windows 10 para una actualización a Windows 11 y automatice el proceso de actualización usando políticas de FleetDM y scripts de PowerShell, incluida la clasificación del dispositivo, la evaluación de elegibilidad y la activación de la instalación de la actualización."
---

Este artículo detalla el proceso para **verificar qué dispositivos Windows 10 son elegibles para una actualización a Windows 11** y **iniciar automáticamente esa actualización** usando **políticas FleetDM y scripts de PowerShell**.

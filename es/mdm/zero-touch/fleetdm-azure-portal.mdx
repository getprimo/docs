...
description: "Para realizar la transición de Intune a FleetDM como su solución MDM, siga los pasos para declarar el dominio FleetDM, cree la aplicación Fleet con los permisos necesarios y configure FleetDM como el MDM predeterminado para nuevos dispositivos en Azure Portal."
---

<Tip>
[Encuentre aquí toda la información](/es/mdm/zero-touch/zero-touch-windows) relacionada con el piloto automático Windows y la implementación Zero-Touch en Windows con Primo.
</Tip>

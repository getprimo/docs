...
3. Establezca la contraseña de la cuenta:
...
La política crea una cuenta de administrador local y almacena la contraseña. Las opciones de contraseña (aleatorias o fijas) y la reducción de privilegios para otras cuentas funcionan de la misma manera que en macOS.
...
- Documente las excepciones de macOS SecureToken en los procedimientos internos de TI.

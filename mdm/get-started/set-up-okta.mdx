...
This article outlines the steps required to configure Okta and prepare for deploying Single Sign-On (SSO) via Platform Single Sign-On on devices managed through Primo.
...
2. Ensure the **Device Access** tab is visible (next to _Endpoint Management_)

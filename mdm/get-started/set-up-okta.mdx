---
title: "Set up Okta authentication integration on your devices"
...
To finalize the deployment of **Okta Platform SSO**, go to a profile in Primo: [https://app.getprimo.com/profiles](https://app.getprimo.com/profiles)

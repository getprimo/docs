...
A device is considered **partially enrolled** when the enrollment process (or MDM deployment) has not been fully completed. As a result, the MDM is not yet active on the device.
...
![Screenshot: Troubleshooting](/images/notion-import/resolve-enrollment-issues__img-023__block-0054__1b543d9f.png)

...
5. Finally, **confirm**.
    ![Screenshot: Disk Encryption](/images/notion-import/cis-benchmarks__img-099__block-0025__26843d9f.png)
...
![Screenshot: Password policy & Automatic ScreenLock](/images/notion-import/cis-benchmarks__img-100__block-0035__26843d9f.png)
...
4. Click on "turn on setting"
5. Finally, **confirm.**
    ![Screenshot: Built-in Firewall](/images/notion-import/cis-benchmarks__img-101__block-0044__26843d9f.png)
...
Follow the same steps as the macOS Disk Encryption section above — the Encryption card in profiles applies to both platforms.
...
Follow the same steps as the macOS Built-in Firewall section above — the Firewall card in profiles applies to both platforms.
